  ...
  >
    <div class="max-w-md mx-auto space-y-4">
      ...
      >
        ...
        <div class="relative z-10 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative">
              <div
                class="absolute inset-0 rounded-full bg-linear-to-tr from-sky-400 to-yellow-500 blur-md opacity-60"
              ></div>
              <div
      ...
      <section class="w-full flex justify-between gap-2 items-center">
        ...
        <div v-for="value in UserAction" class="cursor-pointer h-12 w-full flex justify-center items-center gap-2 rounded-full bg-gray-900 bg-linear-to-br from-white/5 via-white/10 to-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
      ...
      <section class="w-full">
        <div class="flex w-full items-center justify-between gap-2">
          <p class="p-2 rounded-full bg-amber-400/10 text-xs">
            {{ t('membership_center') }}
          </p>
        ...
        <div v-for="value in MembershipCenter" class="cursor-pointer my-2 flex flex-col items-center gap-2" @click="value.action">
          <div class="h-14 w-14 flex flex-col rounded-full justify-center items-center bg-yellow-400/10 bg-linear-to-br from-yellow/5 via-yellow/10 to-yellow/5 backdrop-blur-2xl border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
