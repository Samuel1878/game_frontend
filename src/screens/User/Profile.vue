...
<section
  ...
  >
    ...
    <div class="absolute -top-24 -right-24 w-64 h-64 bg-yellow-500/80 rounded-full blur-[80px] pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-50"></div>
    <div class="absolute -bottom-24 -left-24 w-64 h-64 bg-sky-500/700 rounded-full blur-[80px] pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-50"></div>
        ...
        <div class="flex items-center gap-5">
          <div class="relative">
            ...
            <div v-if="authStore.user" 
                 ...
                 :class="authStore.user?.is_oneline ? 'bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.8)]' : 'bg-red-500'">
            </div>
          </div>
      ...
      <div class="grid grid-cols-2 gap-3 md:gap-4 relative z-10">
        ...
        <div class="bg-linear-to-br from-white/5 to-transparent border border-white/5 backdrop-blur-md rounded-2xl p-4 flex items-center gap-4 group-hover:-translate-y-1 transition-all duration-300 hover:border-yellow-500/30">
          ...
          <div>
            ...
            <p class="text-md md:text-xl font-bold text-white drop-shadow-[0_2px_10px_rgba(255,255,255,0.2)]">
        ...
        <div class="bg-linear-to-br from-white/5 to-transparent border border-white/5 backdrop-blur-md rounded-2xl p-4 flex items-center gap-4 group-hover:-translate-y-1 transition-all duration-300 hover:border-sky-500/30 delay-75">
          <div class="w-10 h-10 rounded-lg bg-sky-500/10 flex items-center justify-center border border-sky-500/20">
          ...
          <div>
            ...
            <p class="text-xs md:text-md font-bold text-white">
              {{ authStore.user?.created_at ? moment(authStore.user?.created_at).format("DD MMM YYYY") : '—' }}
            </p>
          </div>
        </div>
      </div>
