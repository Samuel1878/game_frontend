...
import { Headset, KeyRoundIcon , ChevronRight, UserLock } from "lucide-vue-next";
import { useI18n } from "vue-i18n";
const { t } = useI18n();
</script>
<template>

    <div class="min-h-screen bg-gray-900 w-full">
        <CustomNavBar title="security_center" backTo="/user/profile">
            <template #right>
