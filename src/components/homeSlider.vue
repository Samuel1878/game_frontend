  ...
  <div class="w-full">
    ...
    >
      ...
      >
        ...
        <!-- <div class="absolute left-4 bottom-4 top-6 flex flex-col justify-between">
          <div>
            <p class="text-xl font-extrabold text-white/80 mb-2">
              {{ t(slide.title) }}
            </p>

            <p class="text-gray-300/80 text-sm w-3/4 font-medium">
              {{ t(slide.description) }}
            </p>
          </div>
